...
msScene::msScene()
{
   ...
   groundBodyDef.position.Set(0.0f, 1.99f);
...
void msScene::init()
{
    ...
    m_worldRenderer = new msWorldRenderer(m_shaders.getProgramByName("boxgrid"));
    m_worldRenderer->SetFlags(1); // draw shapes
